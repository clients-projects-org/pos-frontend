				...
				<Motion>
					{data?.data && (
						<TableBox<any>
							...
							columns={SellPaymentComponents.Column}
							data={data?.data}
							TFilters={
								<SellPaymentComponents.Filter
									value={value}
									setValue={setValue}
								/>
							}
